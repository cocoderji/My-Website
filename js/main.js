...
function e() {
    l.classList.add("wave"), setTimeout(function() {
...
s.addEventListener("click", function() {
    i.checked ? c.classList.remove("night") : c.classList.add("night")
});
const l = document.querySelector(".emoji.wave-hand");
setTimeout(function() {
    e()
}, 1e3), l.addEventListener("mouseover", function() {
